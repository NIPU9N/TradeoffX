        ...
        {pendingReviews.length === 0 ? (
          ...
          <div className="grid gap-4">
            {pendingReviews.map((trade) => (
              <Link key={trade.id} href={`/review?id=${trade.id}`} className="glass-card p-6 flex flex-col md:flex-row md:items-center justify-between group hover:border-tx-primary/50 transition-colors overflow-hidden">
                <div className="min-w-0 flex-1 mb-4 md:mb-0 md:pr-4">
                  <div className="flex items-center gap-3 mb-2 flex-wrap">
                    <h3 className="font-syne text-xl font-bold text-white group-hover:text-tx-primary transition-colors break-words">{trade.asset_name}</h3>
                  ...
                  <p className="text-sm text-tx-text-secondary italic line-clamp-3">"{trade.thesis}"</p>
                </div>
                <div className="flex shrink-0">
                  <div className="w-full md:w-auto px-5 py-2.5 bg-tx-primary/10 text-tx-primary border border-tx-primary/30 rounded-lg text-sm font-medium group-hover:bg-tx-primary group-hover:text-tx-bg transition-colors flex items-center justify-center gap-2">
