...
function AppContent({ children }: { children: React.ReactNode }) {
  ...
  return (
    <>
      <Sidebar />
      <div className="md:hidden flex items-center justify-between p-4 bg-[#0A0A14] border-b border-[#222] sticky top-0 z-30">
        ...
        <button onClick={() => setMobileOpen(true)} className="p-2 text-tx-text-secondary hover:text-white">
